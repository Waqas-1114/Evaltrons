export const INDIAN_STATES_DISTRICTS = {
  ...
  "Karnataka": [
    ...
    "Raichur", "Ramanagara", "Shimoga", "Tumkur", "Udupi", "Uttara Kannada", "Vijayapura", "Yadgir"
  ],
  "Kerala": [
  ...
  "Madhya Pradesh": [
    ...
    "Betul", "Bhind", "Bhopal", "Burhanpur", "Chachaura", "Chandauli", 
...
export const getDistrictsByState = (state: string): string[] => {
  return INDIAN_STATES_DISTRICTS[state as keyof typeof INDIAN_STATES_DISTRICTS] || [];
};
